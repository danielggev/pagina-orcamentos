...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bestSellers = [
    ...
    ['bestseller-super-mini.webp', 'Etiqueta Super Mini', 'Tamanho mini e utilidade máxima. Ideais para lápis e canetas.', 'De R$ 24,90', '3x R$ 8,30', '385 reviews', 'etiqueta-super-mini'],
  ...
  const kits = [
    ['kit-fofo.webp', 'Etiquetas Kit Super Fofo', "Etiquetas em vinil à prova d'água com muita personalidade.", 'De R$ 98,90', '3x R$ 32,97', '367 reviews', 'etiquetas-kit-super-fofo'],
    ['kit-contorno.webp', 'Etiquetas Transparentes com Contorno', 'Acabamento discreto para diferentes objetos.', 'R$ 43,90', '3x R$ 14,63', '2 reviews', 'kit-de-etiquetas-transparentes-com-contorno-personalizadas'],
    ['kit-enxuto.webp', 'Kit Enxuto', 'Kit compacto, prático e perfeito para começar.', 'R$ 42,90', '3x R$ 14,30', '103 reviews', 'kit-enxuto'],
    ['kit-teen.webp', 'Etiquetas Kit Teen', 'Etiquetas grandes, médias e super minis.', 'De R$ 50,90', '3x R$ 16,97', '372 reviews', 'etiquetas-kit-teen'],
    ['kit-completo.webp', 'Kit Completo', 'Para roupas, sapatos, objetos e tags de mochila.', 'De R$ 153,90', '3x R$ 51,30', '208 reviews', 'kit-completo']
  ];
  ...
  footer.innerHTML = `
    ...
    <div class="store-shell store-footer__grid">
      <div><img class="store-footer__logo" src="assets/images/logo-2-white.png" alt="Grudado em Você"><p>A solução para identificação e organização. Produtos feitos à mão e embalados com carinho.</p><div class="store-footer__social"><a href="https://instagram.com/grudadoemvoce">Instagram</a><a href="https://www.facebook.com/grudadoemvoce">Facebook</a></div></div>
      <nav aria-label="Ajuda"><h2>Ajuda</h2><a href="https://grudadoemvoce.zendesk.com/">Perguntas Frequentes</a><a href="${storeUrl}/blogs/news">Blog</a><a href="${storeUrl}/pages/quem-somos">Quem Somos</a><a href="${storeUrl}/policies/privacy-policy">Política de Privacidade e Cookies</a><a href="https://parceria.grudadoemvoce.com.br/">Programa de Afiliados</a></nav>
      <div><h2>Fale conosco</h2><p>Atendimento de:<br><strong>Segunda à Sexta-feira<br>Das 09:00h às 18:00h</strong></p><p>E-mail:<br><a href="mailto:contato@grudadoemvoce.com.br">contato@grudadoemvoce.com.br</a></p><p>Telefones:<br>(21) 2018-2074 ou (11) 3181-6202</p></div>
